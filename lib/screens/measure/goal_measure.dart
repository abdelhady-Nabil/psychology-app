                  ...
                  child: Column(
                    children: [
                      Container(
                        alignment: Alignment.topRight,
                        child: CustomText(
                          text: 'هدفنا من هذا المقياس $title لديك لنتمكن من تقديم الاستشاره النافعه لك  لنتمكن من تقديم الاستشاره النافعه لك ومساعدتك في تحسين صحتك النفسيه بشكل افضل',
                          fontSize: 15,
                        ),
                      ),
                      SizedBox(
